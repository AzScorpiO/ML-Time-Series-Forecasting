...
# 记录程序结束时间并计算运行时间
end_time = time.time()
lstm_50_execution_time = end_time - start_time
print(f"{lstm_50_execution_time}")

# 将lstm_execution_time输出到lstm_50_execution_time.txt文件
with open('lstm_50_execution_time.txt', 'w') as f:
    f.write(f"{lstm_50_execution_time}")
...
# 将wape_value输出到lstm_50_wape.txt文件
with open('lstm_50_wape.txt', 'w') as f:
