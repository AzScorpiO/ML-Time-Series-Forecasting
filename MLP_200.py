...
# 记录程序结束时间并计算运行时间
end_time = time.time()
mlp_200_execution_time = end_time - start_time
print(f"MLP运行时间为: {mlp_200_execution_time} 秒")

# 将mlp_200_execution_time输出到mlp_200_execution_time.txt文件
with open('mlp_200_execution_time.txt', 'w') as f:
    f.write(f"{mlp_200_execution_time}")

# 将mlp_execution_time输出到mlp_execution_time.txt文件
with open('mlp_200_execution_time.txt', 'w') as f:
    f.write(f"{mlp_200_execution_time}")
...
# 将wape_value输出到mlp_200_wape.txt文件
with open('mlp_200_wape.txt', 'w') as f:
