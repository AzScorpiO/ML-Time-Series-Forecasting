...
# 记录程序结束时间并计算运行时间
end_time = time.time()
rnn_50_execution_time = end_time - start_time
print(f"RNN运行时间为: {rnn_50_execution_time} 秒")

# 将rnn_50_execution_time输出到rnn_50_execution_time.txt文件
with open('rnn_50_execution_time.txt', 'w') as f:
    f.write(f"{rnn_50_execution_time}")    
...
with open('rnn_50_wape.txt', 'w') as f:
